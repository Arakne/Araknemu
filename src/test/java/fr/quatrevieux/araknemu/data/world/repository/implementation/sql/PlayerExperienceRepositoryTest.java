...
class PlayerExperienceRepositoryTest extends GameBaseCase {
    private PlayerExperienceRepository repository;
    ...
    public void setUp() throws Exception {
        ...
        repository = new PlayerExperienceRepository(app.database().get("game"));
    }
