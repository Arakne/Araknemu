...
class RingAreaTest extends GameBaseCase {
    ...
    void resolveSize0() {
        assertEquals(
            ...
            new RingArea(new EffectArea(EffectArea.Type.LINE, 0)).resolve(map.get(123), map.get(123))
        );
    }
    ...
    void resolve() {
        assertCollectionEquals(
            new RingArea(new EffectArea(EffectArea.Type.LINE, 2)).resolve(map.get(123), map.get(137)),
