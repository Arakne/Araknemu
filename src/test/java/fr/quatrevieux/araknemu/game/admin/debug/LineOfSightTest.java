...
class LineOfSightTest extends GameBaseCase {
    ...
    void success() {
        ...
        requestStack.assertLast(
            new FightStartPositions(
                new List[] {
                    Arrays.asList(187, 188, 200, 201, 202, 213, 214, 215, 216, 217, 227, 228, 229, 230, 231, 240, 241, 242, 243, 244, 245, 246, 253, 254, 255, 256, 257, 258, 259, 260, 268, 269, 270, 271, 272, 273, 274, 275, 420),
    ...
    void withTarget() {
        ...
        requestStack.assertLast(
            new FightStartPositions(
                new List[] {
                    Arrays.asList(282, 268, 283, 269),
                    Arrays.asList(265, 280, 266, 281, 267),
                },
                0
            )
        );
