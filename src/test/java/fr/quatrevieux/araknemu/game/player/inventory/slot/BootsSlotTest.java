...
class BootsSlotTest extends GameBaseCase {
    ...
    public void setUp() throws Exception {
        ...
        slot = new BootsSlot(new DefaultListenerAggregate(), Mockito.mock(ItemStorage.class));
    }
    ...
    void checkBadQuantity() throws ContainerException {
        assertFalse(slot.check(container.get(ItemService.class).create(2422), 10));
    }
    ...
    void checkAlreadySet() throws ContainerException {
        ...
        assertFalse(slot.check(container.get(ItemService.class).create(2422), 1));
    }

    @Test
    void checkSuccess() throws ContainerException {
        assertTrue(slot.check(container.get(ItemService.class).create(2422), 1));
    }
