...
class HelmetSlotTest extends GameBaseCase {
    ...
    public void setUp() throws Exception {
        ...
        slot = new HelmetSlot(new DefaultListenerAggregate(), Mockito.mock(ItemStorage.class));
    }
    ...
    void checkBadQuantity() throws ContainerException {
        assertFalse(slot.check(container.get(ItemService.class).create(2411), 10));
    }
    ...
    void checkSuccess() throws ContainerException {
        assertTrue(slot.check(container.get(ItemService.class).create(2411), 1));
    }
