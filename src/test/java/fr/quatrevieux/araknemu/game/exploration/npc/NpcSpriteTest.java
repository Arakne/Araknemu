...
class NpcSpriteTest extends GameBaseCase {
    ...
    void simpleNpc() {
        NpcSprite sprite = new NpcSprite(new GameNpc(
            ...
            new NpcTemplate(878, 40, 100, 100, Sex.MALE, new Colors(8158389, 13677665, 3683117), "0,20f9,2a5,1d5e,1b9e", -1, 0, null),
            new ArrayList<>(),
    ...
    void withCustomArtworkAndExtraClip() {
        NpcSprite sprite = new NpcSprite(new GameNpc(
            new Npc(472, 878, new Position(10340, 82), Direction.SOUTH_EAST, new int[] {3786}),
            new NpcTemplate(878, 40, 100, 100, Sex.MALE, new Colors(8158389, 13677665, 3683117), "0,20f9,2a5,1d5e,1b9e", 4, 9092, null),
            new ArrayList<>(),
            Collections.emptyList()
        ));
