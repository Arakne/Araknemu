...
class SkipTurnSimulatorTest extends FightBaseCase {
    private Fight fight;
    private PlayerFighter fighter;
    private FighterAI ai;
    private SkipTurnSimulator simulator;
    ...
    public void setUp() throws Exception {
        ...
        simulator = new SkipTurnSimulator(1000);
    }
    ...
    void simulateArea() {
        ...
        assertEquals(-1000, simulation.enemiesBoost());
    }
    ...
    void score() {
        ...
        assertEquals(1000, score.score());
        assertEquals(1000, score.debuff());
    }
}
