...
class MultiplyDamageSimulatorTest extends FightBaseCase {
    private Fight fight;
    private PlayerFighter fighter;
    private FighterAI ai;
    private MultiplyDamageSimulator simulator;
    ...
    public void setUp() throws Exception {
        ...
        simulator = new MultiplyDamageSimulator(300);
    }
    ...
    void simulateSimple() {
        ...
        assertEquals(600, simulation.selfBoost());
    }
    ...
    void simulateBuff() {
        ...
        simulator.simulate(simulation, ai, scope.effects().get(0));
        assertEquals(1500, simulation.selfBoost());

        Mockito.when(effect.duration()).thenReturn(20);
        simulation = new CastSimulation(spell, fighter, fighter.cell());
        scope = makeCastScope(fighter, spell, effect, fighter.cell());
        simulator.simulate(simulation, ai, scope.effects().get(0));
        assertEquals(3000, simulation.selfBoost());
    ...
    void simulateArea() {
        ...
        assertEquals(300, simulation.selfBoost());
        assertEquals(300, simulation.enemiesBoost());
    }
