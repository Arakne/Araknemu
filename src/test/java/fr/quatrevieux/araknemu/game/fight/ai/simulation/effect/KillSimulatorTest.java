...
class KillSimulatorTest extends FightBaseCase {
    private Fight fight;
    private PlayerFighter fighter;
    private Fighter target;
    private FighterAI ai;
    private KillSimulator simulator;
    ...
    public void setUp() throws Exception {
        ...
        simulator = new KillSimulator();
    }

    @Test
    void simulateSimple() {
        assertEquals(-50, simulate().enemiesLife());
        assertEquals(1, simulate().killedEnemies());
    ...
    void simulateArea() {
        ...
        assertEquals(-295, simulation.selfLife());
