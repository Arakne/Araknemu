...
public class LifeRegeneration implements Listener<ExplorationPlayerCreated> {
    final ExplorationPlayer exploration;

    public LifeRegeneration(ExplorationPlayer exploration) {
    ...
    public void on(ExplorationPlayerCreated event) {
        exploration.player().startLifeRegeneration();
    }
}
