...
/**
 * Boost the sight of the spell caster
 *
 * @see Characteristic#SIGHT_BOOST
 * @see DecreaseCasterSightHandler Reverse effect
 */
public final class BoostCasterSightHandler implements EffectHandler, BuffHook {
    private final Fight fight;

    public BoostCasterSightHandler(Fight fight) {
        this.fight = fight;
    }
