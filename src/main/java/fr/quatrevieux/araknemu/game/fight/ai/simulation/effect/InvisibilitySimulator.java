...
/**
 * Simulator for invisibility effect
 * This simulator will simply add a boost if the is not yet hidden
 *
 * @see fr.quatrevieux.araknemu.game.fight.castable.effect.handler.misc.InvisibilityHandler The simulated effect
 */
public final class InvisibilitySimulator implements EffectSimulator {
    private final @Positive int boost;

    /**
     * @param boost The boost value
     */
    public InvisibilitySimulator(@Positive int boost) {
        this.boost = boost;
    }
    ...
    public void simulate(CastSimulation simulation, AI ai, CastScope.EffectScope<? extends FighterData, ? extends BattlefieldCell> effect) {
        ...
        final int value = boost * duration;
