 ...
 */
public final class ShowCell extends AbstractFightingPacketHandler<ShowCellRequest> {
    @Override
    public void handle(GameSession session, Fight fight, PlayerFighter fighter, ShowCellRequest packet) throws Exception {
