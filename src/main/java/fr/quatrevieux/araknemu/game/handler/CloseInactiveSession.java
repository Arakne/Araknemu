 ...
 *
 * @todo refactor with realm
 */
public final class CloseInactiveSession implements PacketHandler<GameSession, SessionIdle> {
    @Override
    public void handle(GameSession session, SessionIdle packet) {
