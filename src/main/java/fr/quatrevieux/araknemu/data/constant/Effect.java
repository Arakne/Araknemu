...
public enum Effect {
    ...
    ADD_INITIATIVE(174,           Type.CHARACTERISTIC),
    SUB_INITIATIVE(175,           Type.CHARACTERISTIC),
    ADD_DISCERNMENT(176,          Type.CHARACTERISTIC),
    SUB_DISCERNMENT(177,          Type.CHARACTERISTIC),
    ...
    ADD_CHARACT_FORCE(607,        Type.USE),
    ADD_CHARACT_CHANCE(608,       Type.USE),
    ADD_CHARACT_AGILITE(609,      Type.USE),
    ADD_CHARACT_VITALITE(610,     Type.USE),
    ...
    ADD_CHARACT_SAGESSE(678, Type.USE),
