 ...
 */
final class ItemSetRepository implements fr.quatrevieux.araknemu.data.world.repository.item.ItemSetRepository {
    ...
    public ItemSetRepository(ConnectionPool pool, Transformer<List<List<ItemTemplateEffectEntry>>> bonusTransformer) {
        this.bonusTransformer = bonusTransformer;
        this.pool = new ConnectionPoolUtils(pool);
        utils = new RepositoryUtils<>(this.pool, new ItemSetRepository.Loader());
    }
