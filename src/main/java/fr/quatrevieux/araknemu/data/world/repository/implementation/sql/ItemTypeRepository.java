 ...
 */
final class ItemTypeRepository implements fr.quatrevieux.araknemu.data.world.repository.item.ItemTypeRepository {
    ...
    public ItemTypeRepository(ConnectionPool pool, Transformer<EffectArea> areaTransformer) {
        this.areaTransformer = areaTransformer;
        this.pool = new ConnectionPoolUtils(pool);
        utils = new RepositoryUtils<>(this.pool, new ItemTypeRepository.Loader());
    }
